...
ARG BUILD_CONFIGURATION=Release
RUN dotnet publish "./Collaborative-Task-Management-System.csproj" -c $BUILD_CONFIGURATION -o /app/publish /p:UseAppHost=false

# This stage is used in production or when running from VS in regular mode (Default when not using the Debug configuration)
FROM base AS final
WORKDIR /app
COPY --from=publish /app/publish .
ENTRYPOINT ["dotnet", "Collaborative-Task-Management-System.dll"]